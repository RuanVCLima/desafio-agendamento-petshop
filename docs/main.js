...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   validatingTime: () => (/* binding */ validatingTime)\n/* harmony export */ });\n/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ \"./node_modules/dayjs/dayjs.min.js\");\n/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _services_schedule_new_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/schedule-new.js */ \"./src/services/schedule-new.js\");\n/* harmony import */ var _services_schedule_fetch_by_day_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/schedule-fetch-by-day.js */ \"./src/services/schedule-fetch-by-day.js\");\n/* harmony import */ var _schedules_show_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../schedules/show.js */ \"./src/modules/schedules/show.js\");\n/* harmony import */ var _hours_load_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./hours-load.js */ \"./src/modules/form/hours-load.js\");\n\n\n\n\n\nconst form = document.querySelector(\"form\");\nconst btNewSchedule = document.getElementById(\"bt-new-schedule\");\nconst modal = document.getElementById(\"modal\");\nconst closeModal = document.getElementById(\"close-modal\");\nconst personalDate = document.getElementById(\"date\");\nconst chosingDate = document.getElementById(\"date-schedule\");\nconst time = document.getElementById(\"time\");\nconst nameOfTutor = document.getElementById(\"name-of-tutor\");\nconst nameOfPet = document.getElementById(\"name-of-pet\");\nconst phone = document.getElementById(\"phone\");\nconst service = document.getElementById(\"service\");\nconst actualDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(new Date()).format(\"YYYY-MM-DD\");\npersonalDate.value = actualDate;\nchosingDate.value = actualDate;\npersonalDate.min = actualDate;\nchosingDate.min = actualDate;\nasync function validatingTime() {\n  const actualDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()().startOf(\"day\");\n  const chosenDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(chosingDate.value);\n  let date = chosenDate;\n  const dailySchedules = await (0,_services_schedule_fetch_by_day_js__WEBPACK_IMPORTED_MODULE_2__.scheduleFetchByDay)({\n    date\n  });\n  date = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(chosingDate.value).format(\"DD\");\n  time.innerHTML = \"\";\n  const currentHour = dayjs__WEBPACK_IMPORTED_MODULE_0___default()().hour();\n  const currentMinute = dayjs__WEBPACK_IMPORTED_MODULE_0___default()().minute();\n  for (let hour = 9; hour <= 21; hour++) {\n    const timeRange = `${String(hour).padStart(2, \"0\")}:00`;\n    const option = document.createElement(\"option\");\n    option.value = timeRange;\n    option.textContent = timeRange;\n    if (chosenDate.isSame(actualDate, \"day\") && (hour < currentHour || currentHour === hour && currentMinute > 0)) {\n      option.disabled = true;\n    }\n    dailySchedules.forEach(element => {\n      const storedHour = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(element.when).format(\"HH\");\n      const storedDay = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(element.when).format(\"DD\");\n      if (storedHour == hour && storedDay == date) {\n        option.disabled = true;\n        console.log(\"disabled\");\n      }\n    });\n    time.appendChild(option);\n  }\n}\nchosingDate.addEventListener(\"change\", () => {\n  validatingTime();\n});\npersonalDate.addEventListener(\"change\", async () => {\n  const date = personalDate.value;\n  const dailySchedules = await (0,_services_schedule_fetch_by_day_js__WEBPACK_IMPORTED_MODULE_2__.scheduleFetchByDay)({\n    date\n  });\n  (0,_schedules_show_js__WEBPACK_IMPORTED_MODULE_3__.schedulesShow)({\n    dailySchedules\n  });\n});\ncloseModal.addEventListener(\"click\", event => {\n  event.preventDefault();\n  modal.style.display = \"none\";\n});\nbtNewSchedule.addEventListener(\"click\", event => {\n  event.preventDefault();\n  modal.style.display = \"flex\";\n  validatingTime();\n});\nform.onsubmit = async event => {\n  try {\n    event.preventDefault();\n    const name = nameOfTutor.value.trim();\n    const namePet = nameOfPet.value.trim();\n    const celphone = phone.value.trim();\n    const descriptionService = service.value.trim();\n    const hourSelected = time.value;\n    const [hour] = hourSelected.split(\":\");\n    const when = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(chosingDate.value).add(hour, \"hour\");\n    const id = new Date().getTime();\n    console.log(id, name, namePet, celphone, descriptionService, when);\n    await (0,_services_schedule_new_js__WEBPACK_IMPORTED_MODULE_1__.scheduleNew)({\n      id,\n      nameTutor: name,\n      namePet,\n      celphone,\n      service: descriptionService,\n      when\n    });\n    (0,_hours_load_js__WEBPACK_IMPORTED_MODULE_4__.schedulesDay)();\n    nameOfPet.value = \"\";\n    nameOfTutor.value = \"\";\n    phone.value = \"\";\n    service.value = \"\";\n  } catch (erro) {\n    alert(\"Não foi possível realizar o agendamento.\");\n    console.log(error);\n  }\n};\nvalidatingTime();\n\n//# sourceURL=webpack://Mundo_Pet/./src/modules/form/submit.js?\n}");
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n// Imports\n\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, `*{\r\n    margin: 0;\r\n    padding: 0;\r\n    box-sizing: border-box;\r\n}\r\n\r\n:root{\r\n    --content-primary: #ffffff;\r\n    --content-secondary: #98959d;\r\n    --content-tertiary: #666666;\r\n    --content-brand: #9282fa;\r\n\r\n    --bg-primary: #151515;\r\n    --bg-secondary: #1e1e1e;\r\n    --bg-tertiary:#23242c;\r\n    --bg-brand: #9282fa;\r\n    --bg-highlights: #bdb4fa;\r\n\r\n    --border-primary: #3e3c41;\r\n    --border-secondary: #86818c;\r\n    --border-brand: #9282fa;\r\n    --border-divisor: #353339;\r\n\r\n    --accent-blue: #027df0;\r\n    --accent-blue-light: #16487a;\r\n    --accent-yellow: #f0dc02;\r\n    --accent-yellow-light: #756e1b;\r\n    --accent-orange: #f09102;\r\n    --accent-orange-light: #75501b;\r\n\r\n    --ff-inter-tight: \"Inter Tight\", sans-serif;\r\n    --ff-inter: \"Inter\", sans-serif;\r\n\r\n    --title: 700 1.5rem/1.3 var(--ff-inter-tight);\r\n\r\n    --pg-medium: 400 0.875rem/1.7 var(--ff-inter);\r\n    --pg-small: 400 0.75rem/1.3 var(--ff-inter);\r\n    --lb-large: 700 1rem/1.5 var(--ff-inter);\r\n    --lb-medium: 700 0.875rem/1.7 var(--ff-inter);\r\n    --lb-small: 700 0.75rem/1.3 var(--ff-inter);\r\n    --link: 400 0.75rem/1.3 var(--ff-inter)\r\n\r\n}\r\n\r\nbody{\r\n    background-color: var(--bg-primary);\r\n    display: grid;\r\n    align-items: center;\r\n    justify-content: center;\r\n    position: relative;\r\n}\r\n\r\n.logo{\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n\r\n    background-color: var(--bg-secondary);\r\n    border-bottom-right-radius: 1rem;\r\n    color: var(--content-brand);\r\n    display: flex;\r\n    align-items: center;\r\n    gap: .5rem;\r\n\r\n\r\n    height: 3rem;\r\n    width: 9.5rem;\r\n}\r\n\r\n.your-schedule {\r\n    margin-top: 5rem;\r\n    width: 44.5rem;\r\n    align-items: center;\r\n    justify-content: space-between;\r\n    font: var(--pg-small);\r\n    color: var(--content-secondary);\r\n    margin-bottom: 5rem;\r\n}\r\n\r\n.flex{\r\n    display: flex;\r\n}\r\n.grid{\r\n    display: grid;\r\n}\r\n\r\n.period{\r\n    display: flex;\r\n}\r\n\r\n.title{\r\n    color: var(--content-primary);\r\n    & h1{\r\n        font: var(--title);\r\n    }\r\n    & p{\r\n        color: var(--content-secondary);\r\n    }\r\n}\r\n\r\n.display{\r\n    display: none;\r\n}\r\n\r\n@media (width<80em) {\r\n    .your-schedule{\r\n        flex-direction: column;\r\n        width: 21.8rem;\r\n        gap: 1rem;\r\n        padding: 1rem;\r\n        align-items: flex-start;\r\n    }\r\n}`, \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://Mundo_Pet/./src/style/global.css?./node_modules/css-loader/dist/cjs.js\n}");

/***/ },

/***/ "./node_modules/css-loader/dist/cjs.js!./src/style/schedule.css"
/*!**********************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/style/schedule.css ***!
  \**********************************************************************/
(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n// Imports\n\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, `.list{\r\n    color: var(--content-primary);\r\n    width: 44.5rem;\r\n    height: auto;\r\n    gap: 1rem;\r\n    background-color: var(--bg-secondary);\r\n    border-radius: .5rem;\r\n    padding: 1rem;\r\n    margin-bottom: 2rem;\r\n    \r\n\r\n    & ul{\r\n        width: 100%;\r\n        justify-content: space-between;\r\n        text-decoration: none;\r\n        list-style: none;\r\n        & li{\r\n            width: 100%;\r\n            justify-content: space-between;\r\n        }\r\n    }\r\n}\r\n\r\n.time{\r\n    justify-content: space-between;\r\n    border-bottom: 1px solid var(--bg-tertiary);\r\n    padding-bottom: 1rem;\r\n    & .flex{\r\n        gap: .5rem;\r\n    }\r\n}\r\n\r\n.gray{\r\n    color: var(--content-secondary);\r\n}\r\n\r\n.tertiary{\r\n    color: var(--content-tertiary);\r\n}\r\n\r\n.remove{\r\n    cursor: pointer;\r\n}\r\n\r\nbutton{\r\n    all: unset;\r\n\r\n    position: fixed;\r\n    bottom: 2rem;\r\n    right: 2rem;\r\n\r\n    width: 13.6rem;\r\n    height: 3rem;\r\n\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n\r\n    color: #050505;\r\n    background-color: var(--bg-brand);\r\n    border-radius: .5rem;\r\n\r\n    font: var(--lb-medium);\r\n    cursor: pointer;\r\n    \r\n    \r\n}\r\n\r\n@media (width<80em) {\r\n    .list{\r\n        width: 21.875rem;\r\n        display: grid;\r\n        gap: 1rem;\r\n\r\n        & ul li {\r\n        display: grid;\r\n        grid-template-columns: max-content 1fr auto;\r\n        grid-template-rows: auto auto;\r\n        column-gap: .5rem;\r\n        row-gap: .4rem;\r\n        }\r\n\r\n        & .time {\r\n            grid-column: 1;\r\n            grid-row: 1;\r\n        }\r\n\r\n        & .name {\r\n            grid-column: 2/4;\r\n            grid-row: 1;\r\n        }\r\n\r\n        & .service {\r\n            grid-column:  1;\r\n            grid-row: 2;\r\n        }\r\n\r\n        & .remove {\r\n            grid-column: 3;\r\n            grid-row: 2;\r\n            justify-self: end;\r\n            align-self: end;\r\n        }\r\n    }\r\n\r\n    footer{\r\n        position: relative;\r\n        width: 100%;\r\n        height: 7.25rem;\r\n        background-color: var(--bg-secondary);\r\n        position: fixed;\r\n        bottom: 2rem;\r\n        display: flex;\r\n        align-items: center;\r\n        justify-content: center;\r\n        \r\n\r\n        & button{\r\n            position: unset;\r\n        }\r\n    }\r\n   \r\n    \r\n}`, \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://Mundo_Pet/./src/style/schedule.css?./node_modules/css-loader/dist/cjs.js\n}");
...
"use strict";
eval("{module.exports = __webpack_require__.p + \"fcf3c859b9b4dd135ff6.svg\";\n\n//# sourceURL=webpack://Mundo_Pet/./src/assets/icon.svg?\n}");
